  ...
  return (
    <div className="w-full h-80 bg-slate-700 flex justify-evenly items-center text-center text-cyan-50 ">
      <div>
        <div>LOGO</div>
        <div className="m-10">
          <p className="text-red-300 font-semibold m-2">
            Precisa entrar em contato com a gente?
          </p>
          <p>Atendimento de segunda a sexta, das 08h as 18h</p>
        </div>
        <p className="text-red-300 font-semibold m-2w 3           ">
      ...
      <div className="">
        <h1 className="text-red-300">Onde estamos localizados</h1>
        <iframe
